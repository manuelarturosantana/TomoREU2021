function [x_k, iterInfo] = BCD(inputs)
    %This function will work essentially the same, except the inputs will
    %work a little differently, it will need both options and probInfo.
    %Possibly PRtomo_var as it currently stands will need to be a new
    %function, and optparam parallel will stand as is.
