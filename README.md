...
1. [Refactor](refactor) : Contains all the needed code beyond the above toolboxes and packages. It includes a script [Refactored_Example1.m](refactor/Refactor_Example1.m) which gives a detailed example of how to run the code.
